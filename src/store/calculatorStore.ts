...
class CalculatorStore {
  ...
  public getCostStringFromNutrient(nutrientIndex, amounts, multiplier): String {
  ...
  public calculateSNS(
    ...
    if (this.isPreviousCropGrass(previousCrop) && !this.isCropArable(crop)) {
      ...
      return this.snsSearch(soilNitrogenSupplyTree, params, regularlyManure);
    }
  }
